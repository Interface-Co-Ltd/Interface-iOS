...
class UserViewModel: ObservableObject {
    ...
    init(serverId: String, serverPassword: String) {
        ...
        if self.inputId == serverId && self.inputPassword == serverPassword {
            self.currentUser = User(userId: "ddonguri", userName: "권하윤", gender: "male", studentId: "19010769", major: "전자정보통신공학과", generation: "32", phone: "01063004823", birthday: "980809", password: "1234", auth: "회장")
        } else {
